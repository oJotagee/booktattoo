...
export function Footer() {
  return (
    <footer className="container mx-auto bg-black text-white py-20 space-y-6">
      ...
      <p className="text-center mt-2 text-sm md:text-base text-white/50">Escolha seu flash e garanta sua vaga agora mesmo.</p>
      ...
      <span className="block text-center mt-4 text-white/20 text-sm">© {new Date().getFullYear()} BookInk · Todos os direitos reservados</span>
    </footer>
  )
}